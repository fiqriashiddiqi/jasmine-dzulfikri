<?php
include('../jasmine-dzulfikri/koneksi.php');
?>
<!DOCTYPE html>
<html lang="en-US">
...
<head>
	<meta name="description" content="Undangan pernikahan Jasmine dan Dzulfikri. Jum'at, 24 Desember 2021.">
	<meta property="og:title" content="Undangan pernikahan Jasmine dan Dzulfikri. Jum'at, 24 Desember 2021." />
	<meta property="og:url" content="https://jasmine-dzulfikri.digital-invitation.com/" />
	<meta property="og:description" content="Undangan pernikahan Jasmine dan Dzulfikri. Jum'at, 24 Desember 2021.">
	<meta property="og:image" content="https://jasmine-dzulfikri.digital-invitation.com/1.bp.blogspot.com/-FuprKxe6I3I/X3waINlnqnI/AAAAAAAAFzo/DF1N99KVgt8ZjEiaNubMyRjz17nxGNAxQCLcBGAsYHQ/s16000/AZ--531.jpg">
...
<body class="page-template page-template-page-template-blank page-template-page-template-blank-php page page-id-41900 et_color_scheme_orange et_pb_button_helper_class et_cover_background et_pb_gutter et_pb_gutters3 et_pb_pagebuilder_layout et_smooth_scroll et_no_sidebar et_divi_theme et-db et_minified_js">
    ...
    <div id="main-content">
		...
		<div id="welcome-gate" class="et_pb_section et_pb_section_0 et_animated et_pb_with_background et_section_regular" >
				...
				<div class="et_pb_text_inner"><h2>Kepada Yth</h2>
  ...
  jQuery(document).ready(function($) {
    $('.nothanks').click(function() {
        $('#welcome-gate').addClass('move-gate');
			...
			</div> <!-- .et_pb_section --><div class="et_pb_section et_pb_section_2 et_pb_with_background et_section_regular section_has_divider et_pb_bottom_divider" style="background-color: #e3d6ab!important;">
...
<p>( QS. Ar- Rum 21 )</p></div>
			...
			<div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular" >
				...
				<div class="et_pb_text_inner">
					<h1>Jasmine Medisa Rimadhiani</h1>
                	<p><strong>Putri dari</strong><br> Bpk. Drs. Topik<br> &amp; Ibu Bidan Esum Sumini S.ST</p>
				</div>
			</div> <!-- .et_pb_text -->
				...
				<div class="et_pb_text_inner">
					<h1>Dzulfikri Hussaini Sakti</h1>
                    <p><strong>Putra dari</strong><br> Bpk. Ir. Gunawan<br> &amp; Ibu Dra. Imas Karmasih, MA</p>
				</div>
			</div> <!-- .et_pb_text -->
			</div> <!-- .et_pb_column -->
				...
				<div class="et_pb_module et_pb_countdown_timer et_pb_countdown_timer_0 et_pb_no_bg et_pb_bg_layout_light" data-end-timestamp="1640308088">
			...
			</div> <!-- .et_pb_row --><div class="et_pb_with_border et_pb_row et_pb_row_5" style="border-color: #e3d6ab!important;">
				...
				<a class="et_pb_button et_pb_button_1 et_animated et_pb_bg_layout_light" href="https://goo.gl/maps/8sfAiiy7xhXBJLQb8" target="_blank" style="background-color: #e3d6ab!important;">Google Maps</a>
			</div>
			</div> <!-- .et_pb_column -->
	...
	<div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular" >
					...
					<div class="et_pb_with_border et_pb_row et_pb_row_5" style="border-color: #e3d6ab!important;">
			...
			<div class="et_pb_section et_pb_section_5 et_pb_with_background et_section_regular section_has_divider et_pb_bottom_divider et_pb_top_divider" style="background-color: #e3d6ab!important;">
			...
			<div id="et_pb_contact_form_0" class="et_pb_module et_pb_contact_form_0 et_pb_contact_form_container clearfix" >
				...
				<div class="et_pb_contact">
					<form method="post" action="../jasmine-dzulfikri/tambah_pesan.php">
						...
						<div class="et_contact_bottom_container">
							...
							<button type="submit" class="et_pb_contact_submit et_pb_button" style="background-color: #e3d6ab">Kirim</button>
						</div>
			 ...
			 <!-- .et_pb_row --><div class="et_pb_row et_pb_row_8">
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description"><p><br>Triara &amp; Reza</p></div>
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
			</div> <!-- .et_pb_column -->
