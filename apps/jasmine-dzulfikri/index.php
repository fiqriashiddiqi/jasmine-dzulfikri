...
<p>The Wedding of </p>
<h1 style="font-family:'Vibur',cursive">Jasmine & Dzulfikri</h1>
<script>
...
<p>( QS. Ar- Rum 21 )</p></div>
			...
			<div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular" >
				...
				<a class="et_pb_button et_pb_button_1 et_animated et_pb_bg_layout_light" href="https://g.page/saung_ema_kuningan?share" target="_blank" style="background-color: #a9916b!important;">Google Maps</a>
			</div>
			</div> <!-- .et_pb_column -->
						...
						<div class="swiper-container">
							<div class="swiper-wrapper">
									<?php
								      ...
								      $query = "SELECT * FROM tb_dzul ORDER BY id ASC";
			 ...
			 <!-- .et_pb_row --><div class="et_pb_row et_pb_row_8">
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description"><p><br>Jasmine &amp; Dzulfikri</p></div>
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
			</div> <!-- .et_pb_column -->
